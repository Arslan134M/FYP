...
import { updateRequestStatus } from "../store/Actions/Requests/Requests";
...
function Restaurants(props) {
  ...
  const handleChangeStatus = async (status) => {
    let res = await dispatch(
      updateRequestStatus({ id: user?._id, status: status })
    );
  };
  return (
    <>
        ...
        <Card className={classes.fullCard}>
            ...
            <Grid container justify="space-between">
              <Grid item>
                <img
                  ...
                  src={
                    user?.user_id?.image?baseUrl+"/"+user?.user_id?.image:
                    "https://c8.alamy.com/comp/2AKFW1K/passport-photo-of-african-american-businessman-isolated-on-white-background-for-cut-out-2AKFW1K.jpg"
                  }
                  ...
                  // src={"https://static6.depositphotos.com/1043957/580/i/600/depositphotos_5805232-stock-photo-world-connection.jpg"}
          ...
          >
            ...
            >
              ...
              >
                {props.type === "sent" && user?.status === "pending" && (
                  <span
